  ...
  override fun downloadFile(
    ...
    if (responseCode == HttpURLConnection.HTTP_OK ||
      ...
      while (bytesRead != -1) {
        ...
        parallelDownloadsProgresses[downloadID] =
            if (downloadID == "main") percentString else "[$downloadID] $percentString"
      ...
      if (parallelDownloadsProgresses.isEmpty()) logger.logFullLine("")
